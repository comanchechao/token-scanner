...
const DefiTradesSection: React.FC<DefiTradesSectionProps> = ({
  ...
  return (
    <div className="  min-h-[410px] max-h-[410px] overflow-y-auto scrollbar-hide bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-main-accent/30 rounded-2xl p-4 lg:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-main-accent/5 mb-6">
      {/* Header with search */}
      ...
      <div className="flex justify-center items-center gap-2 mt-5">
        ...
        <div className="px-3 py-1 bg-white/[0.03] border border-white/[0.08] rounded-lg">
          <span className="font-tiktok text-xs text-main-light-text/80">
